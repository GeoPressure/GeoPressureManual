...
tag <- tag_create(id = "CB619") |> tag_label()
```
...
::: callout-warning
## How does the [GeoPressureAPI](https://github.com/GeoPressure/GeoPressureAPI) work?
...
GeoPressureR uses the <a href="https://github.com/GeoPressure/GeoPressureAPI" target="_blank">GeoPressureAPI</a> which serves as an interface to the GEE server.
:::
...
```{r 02-map-pressure-mismatch-create}
#| cache: true
...
```{r 02-map-pressure-likelihood-create}
