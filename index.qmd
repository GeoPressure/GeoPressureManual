...
- [GeoLocator Data Package](geolocator-intro.html) is a data exchange format for geolocator data. In this part, you'll learn how to use the GeoLocatoR package to create a GeoLocator data package.
