...
- [GeoPressureR](https://github.com/GeoPressure/GeoPressureR) is the main R package with functions to run the analysis.
- [GeoPressureManual](index.html) is the official user guide developed to help you learn to use GeoPressureR.
- [GeoPressureTemplate](https://github.com/GeoPressure/GeoPressureTemplate) is a [template Github repository](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template) to help kickstart your project.
- [GeoPressureViz](geopressureviz.html) is a shiny app included in GeoPressureR to visualize the trajectory of your bird.
- [GeoLightViz](geolightviz.html) is another shiny app included in GeoPressureR for labelling twilight data and tuning calibration settings.
- Trainset is yet another shiny app dedicated for the labeling of pressure and acceleration data.
- [GeoLocator Data Package (DP)](https://github.com/GeoPressure/GeoLocatoR-dp) is a data exchange format for geolocator data.
- [GeoLocatoR](https://geopressure.org/GeoLocatoR/) is an R package designed to handle GeoLocator Data Packages.
- [GeoLocatorExplorer](https://geopressure.org/GeoLocatorExplorer/) is a web app to explore geolocator data packages.
...
- [GeoMagR](https://geopressure.org/GeoMagR/) is an R package extending GeoPressureR using 3 axis magnetic data to improve geolocation.
- [GeoPressureAPI](https://github.com/GeoPressure/GeoPressureAPI) is the JSON API used by GeoPressureR under the hood to query the ERA5 reanalysis data with Google Earth Engine.
