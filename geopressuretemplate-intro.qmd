...
- Open [GeoPressureTemplate](https://github.com/GeoPressure/GeoPressureTemplate/) and click on the green button "Use this template" or [click here](https://github.com/GeoPressure/GeoPressureTemplate/generate) to create your repository directly.
...
Alternatively, create your project folder with [`GeoLocatoR::create_geopressuretemplate()`](https://geopressure.org/GeoLocatoR/reference/create_geopressuretemplate.html).

```{r 09-create-geopressuretemplate}
#| eval: false
library(GeoLocatoR)
...
- Click [here](https://github.com/GeoPressure/GeoPressureTemplate/archive/refs/heads/main.zip) to download the repo directly 
...
While publishing your GeoPressureTemplate on Zenodo is a great step to allow others to see (and, if needed, reproduce) your work, it can be a challenge to re-use your track data for other purposes. To facilitate this, we created [GeoLocator Data Package](https://geopressure.org/GeoLocator-DP/), a data exchange format for geolocator data, providing all GeoPressureR outputs in csv files. The aim of GeoLocator DP is re-usability rather than reproduction. 
