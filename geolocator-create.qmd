...
::: callout-note
For an introduction to this format, visit the [GeoLocator DP website](https://geopressure.org/GeoLocator-DP/).
:::


## Install GeoLocatoR
<a href="https://github.com/GeoPressure/GeoLocatoR"><img src="https://geopressure.org/GeoLocatoR/logo.png" align="right" height="139" alt="GeoLocatoR website" style="padding-left:5px;" /></a>

We use the [GeoLocatoR](https://geopressure.org/GeoLocatoR) package to create and validate the data package.
...
Review the [GeoLocator DP curation policy](https://geopressure.org/GeoLocator-DP/curation) before submission.
